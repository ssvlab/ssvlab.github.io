...
//////Elliptic Band Pass from Matlab Fs 48000 Fc 9600-12000, |H|=1.24
float a[] = { 1.0000000000f, -0.2412109375f, 0.5253906250f };
float b[] = { 0.2373046875f, 0.0000000000f, -0.2373046875f };
int k = 2; int l= 10;
int Na = 3; int Nb = 3;
