...
////FIR Low Pass from Matlab using kaiser window Fs 48000 Fc 10800, |H|=1.9375
float a[] = { 1.0 };
float b[] = {0.015625f, 0.015625f, -0.015625f, -0.031250f, 0.0f, 0.031250f, 0.0f, -0.031250f, -0.015625f, 0.046875f,0.046875f,
			-0.046875f, -0.093750f, 0.046875f, 0.31250f, 0.43750f, 0.31250f, 0.046875f, -0.093750f, -0.046875f, 0.046875f,
			 0.046875f, -0.015625f, -0.031250f, 0.0f, 0.031250f, 0.0f, -0.031250f, -0.015625f, 0.015625f, 0.015625f};
int k = 2; int l= 6;
int Na = 1; int Nb = 31;
