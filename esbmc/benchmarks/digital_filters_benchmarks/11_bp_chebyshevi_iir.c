...
////Chebyshev I Band Pass from Matlab Fs 48000 Fc 9600-12000, |H|=1.51                 
float a[] = { 1.0000000f, -0.578125f, 1.703125f, -0.484375f, 0.703125f };
float b[] = { 0.015625f, 0.000000f, -0.046875f, 0.000000f, 0.015625f };
int k = 2; int l= 6;
int Na = 5; int Nb = 5;
