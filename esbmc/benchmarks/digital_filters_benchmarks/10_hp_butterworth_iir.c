...
////Butterworth High Pass from Matlab Fs 48000 Fc 10800, |H|=1.58                      
float a[] = {1.0f, -0.390625f, 0.53125f, -0.078125f, 0.015625f};
float b[] = {0.125f, -0.5f, 0.765625f, -0.5f, 0.125f};
int k = 2; int l= 6;
int Na = 5; int Nb = 5;
