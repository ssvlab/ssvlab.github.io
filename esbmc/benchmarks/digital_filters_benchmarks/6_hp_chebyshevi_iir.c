...
//////Chebyshev I High Pass from Matlab Fs 48000 Fc 14400, |H|=1.33
float a[] = { 1.0000000000f, 0.3515625000f, 0.3300781250f };
float b[] = { 0.2177734375f, -0.4355468750f, 0.2177734375f };
int k = 2; int l= 10;
int Na = 3; int Nb = 3;
