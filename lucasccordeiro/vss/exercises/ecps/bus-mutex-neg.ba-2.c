#if 0
generated by libltl2ba with command: /private/tmp/claude-502/-Users-user-ssvlab-github-io-lucasccordeiro-vss/140cc64b-bb74-4f07-ad6d-d8c5ddc4c52f/scratchpad/libltl2ba/ltl2ba -O c -H "bus.h" -f !G(!({in_T} && {in_P}))
...
Symbol table:
id	symbol			cexpr
0	_ltl2ba_cexpr_0_status	{ in_T }
1	_ltl2ba_cexpr_1_status	{ in_P }
...
#include "bus.h"
char __ESBMC_property__ltl2ba_cexpr_0[] = "in_T";
int _ltl2ba_cexpr_0_status(void) { return in_T; }
char __ESBMC_property__ltl2ba_cexpr_1[] = "in_P";
int _ltl2ba_cexpr_1_status(void) { return in_P; }
...
ltl2ba_fsm(bool state_stats, unsigned int num_iters)
{
	...
	for (iters = 0; iters < num_iters; iters++) {
		...
		case _ltl2ba_state_0:
			state_is_viable = (((1)) || ((_ltl2ba_cexpr_0_status() && _ltl2ba_cexpr_1_status())) || ((false)));
			if (choice == 0) {
				__ESBMC_assume(((1)));
