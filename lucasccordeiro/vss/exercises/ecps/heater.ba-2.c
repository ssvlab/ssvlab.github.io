#if 0
generated by libltl2ba with command: /private/tmp/claude-502/-Users-user-ssvlab-github-io-lucasccordeiro-vss/140cc64b-bb74-4f07-ad6d-d8c5ddc4c52f/scratchpad/libltl2ba/ltl2ba -O c -H "plant.h" -f G({temperature < 20} -> F {heater_on})
...
Symbol table:
id	symbol			cexpr
0	_ltl2ba_cexpr_0_status	{ temperature < 20 }
1	_ltl2ba_cexpr_1_status	{ heater_on }

Stuttering:


!{temperature < 20}&!{heater_on}
Transitions:
1	1	
0	1	
...
#include "plant.h"
char __ESBMC_property__ltl2ba_cexpr_0[] = "temperature < 20";
int _ltl2ba_cexpr_0_status(void) { return temperature < 20; }
char __ESBMC_property__ltl2ba_cexpr_1[] = "heater_on";
int _ltl2ba_cexpr_1_status(void) { return heater_on; }
